...
export function createRouter () {
   return new Router({
      ...
      routes: [
         ...
         {path: '/about/', component: Empty, children: [
            {path: '', name: 'aboutInfo', component: Empty, meta: {parent: 'aboutInfo'}},
            {path: 'team', name: 'aboutTeam', component: Empty, meta: {parent: 'aboutInfo'}},
            {path: 'halls', name: 'aboutHalls', component: Empty, meta: {parent: 'aboutInfo'}},
            {path: 'studio', name: 'aboutStudio', component: Empty, meta: {parent: 'aboutInfo'}},
